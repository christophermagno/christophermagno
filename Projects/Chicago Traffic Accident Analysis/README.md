...
When evaluated alongside supporting factors—such as **primary causes** including *failure to yield* and *tailgating* on a _clear, sunny day_ and _dry road surfaces_—the results suggest that the **absence of traffic control devices** or **non-functioning signals** is a leading contributor to traffic accidents in Chicago.
